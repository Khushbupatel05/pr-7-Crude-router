                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-start">
                                        <div className="ml-3 text-sm text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">
                                            <label htmlFor="remember" className="">Forgot password?</label>
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" className="text-dark  bg-primary-400 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign in</button>
                            </form>
                        </div>
                    </div>
                </div>
